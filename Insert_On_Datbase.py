...
def Error_fun(Error,Function_name,Source_name):
    ...
    sql1 = "INSERT INTO 8(Error_Message,Function_Name,Exe_Name) VALUES('" + str(Error).replace("'","''") + "','" + str(Function_name).replace("'","''")+ "','"+str(Source_name)+"')"
    ...
    while a == 0:
        try:
            ...
            Final_HTML_Document = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\">" +\
                    ...
                    "<body><Blockquote style='border:1px solid; padding:5px; margin: 10px 30px 10px 30px;'>" + get_htmlSource + "</Blockquote></body></html>"
